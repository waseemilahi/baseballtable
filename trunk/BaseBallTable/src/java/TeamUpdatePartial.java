 ...
 */
public class TeamUpdatePartial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeamUpdatePartial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	             ...
	             query = "SELECT PARK_ID FROM BALLPARK";
	              ...
	              String teamComboData = ""; 
		            ...
		            String divComboData = ""; 
			            ...
			            r = s.executeQuery(query);
			            String teamidComboData = ""; 
				       		while(r.next()){
				       			System.out.println("Table Elements: "+r.getString(1)+ " ");
				       			teamidComboData +=  "<option value=\"" + r.getString(1) + "\">" + r.getString(1) + "</option>";
				       		}
	        		r.close();
	            	s.close();
	            	conn.close();
        ...
        String pageText1 = "<HTML>" +
        		...
        		"<BODY>" + 
        		"<CENTER>" +
        		"<FONT SIZE=\"5\" COLOR=\"#006600\" FACE=\"verdana\">Update a Team</FONT>" + 
        		"</CENTER><BR><BR>" + 
    	    ...
    	    "<TD>" + 
    			...
    			String pageText5 = teamidComboData +   
			"</select></TD>"  +
			"</TR>" +
        		"<TR>" + 
        	    "<TD>" + 
        	    "<input type=\"SUBMIT\" name=\"DBChange\" value=\"team update submit\" " +   
...
;
    			//create page
        		out.println(pageText1 + pageText2 + pageText3 + pageText4 + pageText5);
