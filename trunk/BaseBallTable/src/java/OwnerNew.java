 ...
 */
public class OwnerNew extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageText1 = "<HTML>" +
        		...
        		"<BODY>" + 
        		"<CENTER>" +
        		"<FONT SIZE=\"5\" COLOR=\"#006600\" FACE=\"verdana\">Create New Owner</FONT>" + 
        		"</CENTER><BR><BR>" + 
        		...
        		"<TR>" + 
        	    "<TD>" + 
        	    "<input type=\"SUBMIT\" name=\"DBChange\" value=\"owner create submit\" " +   
