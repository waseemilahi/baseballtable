 ...
 */
public class AgentUpdatePartial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgentUpdatePartial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageText1 = "<HTML>" +
        		...
        		"<BODY>" + 
        		"<CENTER>" +
        		"<FONT SIZE=\"5\" COLOR=\"#006600\" FACE=\"verdana\">Update an Agent</FONT>" + 
        		"</CENTER><BR><BR>" + 
        	    ...
        	    "</TR><TR> <TD>Corporation</TD> <TD><INPUT TYPE=\"TEXT\" NAME=\"CORPORATION\" maxlength = \"20\"></TD>        	</TR>" +
        		    "<TR>" + 
            	    "<TD>Agent ID</TD>" + 
            	    "<TD>" + 
            			"<select name=\"AGENT\">";
        		...
        		"<TR>" + 
        	    "<TD>" + 
        	    "<input type=\"SUBMIT\" name=\"DBChange\" value=\"agent update submit\" " +   
