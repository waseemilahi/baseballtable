 ...
 */
public class AgentIDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AgentIDServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            query = select1 + " FROM Agent A WHERE A.AGENT_SSN = " + agentID ;
            ...
            if(count >0)
            {
             ...
             out.println("<caption align=\"center\"><H1>Requested Agent</H1></caption>");
             out.println("<tr>");
             ...
             out.println( "<form action= \"AgentIDServlet\" method = \"POST\"><div  align=\"center\">" );
             ...
             out.println("<input type=\"text\" name = \"AgentID\" value = \""+agentID+"\" style = \"visibility:hidden\">");
             out.println("<table>");
