 ...
 */
public class PlayerUpdatePartial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PlayerUpdatePartial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        		...
	        		query = "SELECT AGENT_SSN FROM AGENT";
		              ...
		              String agentComboData = ""; 
		        		...
		        		query = "SELECT PLAYER_SSN FROM PLAYER";
			              ...
			              r = s.executeQuery(query);
			              String playerComboData = ""; 
			        		while(r.next()){
			        			System.out.println("Table Elements: "+r.getString(1)+ " ");
			        			playerComboData +=  "<option value=\"" + r.getString(1) + "\">" + r.getString(1) + "</option>";
			        	}
	        		r.close();
	            	s.close();
	            	conn.close();
		...
		String pageText4 = playerComboData +   
			"</select></TD>"  +
		"</TR>" +
    		
        		"<TR>" + 
        	    "<TD>" + 
        	    "<input type=\"SUBMIT\" name=\"DBChange\" value=\"player update submit\" " +   
