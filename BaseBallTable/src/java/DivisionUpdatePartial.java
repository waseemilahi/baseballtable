 ...
 */
public class DivisionUpdatePartial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DivisionUpdatePartial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageText1 = "<HTML>" +
        		...
        		"<BODY>" + 
        		"<CENTER>" +
        		"<FONT SIZE=\"5\" COLOR=\"#006600\" FACE=\"verdana\">Update a Division</FONT>" + 
        		"</CENTER><BR><BR>" + 
        		"<FORM METHOD=POST ACTION=\"DBChangeServlet\">" + 
        		"<TABLE ALIGN=\"CENTER\">" + 
        		 
        		"<TR><TD>Location</TD><TD><select name=\"LOCATION\"><option value=\"EAST\">EAST</option><option value=\"CENTRAL\">CENTRAL</option>"+
        		"<option value=\"WEST\" selected=\"selected\">WEST</option></select></TD></TR>" +
        		"<TR><TD>League</TD><TD><select name=\"LEAGUE\"><option value=\"AL\">American League</option><option value=\"NL\" selected=\"selected\">National League</option>"+
        		"</select></TD></TR>" +
        		...
        		"<TR>" + 
        	    "<TD>" + 
        	    "<input type=\"SUBMIT\" name=\"DBChange\" value=\"division update submit\" " +   
