 ...
 */
public class StaffUpdatePartial extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StaffUpdatePartial() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageText1 = "<HTML>" +
        		...
        		"<BODY>" + 
        		"<CENTER>" +
        		"<FONT SIZE=\"5\" COLOR=\"#006600\" FACE=\"verdana\">Update a Staff Member</FONT>" + 
        		"</CENTER><BR><BR>" + 
    		...
    		String pageText3 = staffComboData +   
    			"</select></TD>"  +
    		"</TR>" +
        		"<TR>" + 
        	    "<TD>" + 
        	    "<input type=\"SUBMIT\" name=\"DBChange\" value=\"staff update submit\" " +   
